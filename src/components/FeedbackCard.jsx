...
const FeedbackCard = ({content, name, title, img}) => (
    <div className='
      ...
      <div className='flex flex-col ml-4'>
        <h4 className='font-poppins font-semibold text-[20px] leading-[32px] text-white mt-10'>{name}</h4>
        <p className='font-poppins font-normal text-[16x] leading-[24px] text-dimWhite'>{title}</p>
      </div>
      </div>
  )
